...
\newpage
```{r, fig.cap="Percent of people with poor/fair health for Expanded and Not Expanded States", warning=FALSE, echo=FALSE}
figure2
```
...
```{r, fig.cap="Percent of people with depression in Expanded and Not Expanded States", warning=FALSE, echo=FALSE}
figure3
```
...
\newpage
```{r, fig.cap="Percent of people with checkup wihtin the last year", warning=FALSE, echo=FALSE}
figure4
```

This figure  assess the impact of expansion on proportion of individuals who went to have a check up within the last year. The rational for this figure is that expansion of coverage is tied with access and having the ability to attend preventive care such as a check up is one way i have chosen to operationalize improvements in health outcomes. 
\newpage
